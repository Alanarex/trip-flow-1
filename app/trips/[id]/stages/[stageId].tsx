...
export default function StageDetails() {
      ...
      try {
        ...
        if (!cancelled) {
          if (stageData) {
            ...
            // Convert ISO format to dd/mm/yyyy if date exists
            if (stageData.date) {
              setDateInput(dateUtils.fromISOFormat(stageData.date));
            }
  ...
  // We'll use the utility functions from the DateInput component
  const formatDisplayDate = (dateStr: string | null): string => {
    return dateUtils.formatForDisplay(dateStr);
  };
            ...
            <View style={styles.buttonRow}>
              <TouchableOpacity 
                ...
                onPress={() => {
                  ...
                  if (stage.date) {
                    setDateInput(dateUtils.fromISOFormat(stage.date));
                  } else {
                    setDateInput('');
                  }
                  setEditMode(false);
